            ...
            <aside className="w-72 flex-shrink-0 space-y-6">
                <div className="rounded-[1.75rem] border border-border/70 bg-card/88 p-5 shadow-sm">
                    <div className="space-y-2">
                        ...
                        <h1 className="font-display text-3xl font-semibold tracking-tight">{t('settings')}</h1>
            ...
            <main className="flex-1 overflow-y-auto pr-2">
                <div className="max-w-4xl space-y-6 pb-10">
                    ...
                    {activeTab === "appearance" && (
                        <div className="space-y-6 rounded-[1.75rem] border border-border/70 bg-card/88 p-6 shadow-sm">
